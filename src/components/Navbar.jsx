    ...
    <nav className="bg-white shadow-sm border-b sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <NavLink to="/" className="flex items-center gap-2">
          <img src="https://res.cloudinary.com/dxcmuocjm/image/upload/v1762953966/cherry-blossom_lqwx9f.png" alt="flower-logo" className='h-8 w-auto'/> <h1 className='uppercase text-2xl text-[#1d464a] font-bold'>Cosmico</h1>
        </NavLink>
