...
export default function Home() {
  ...
  return (
    <div className="bg-white ">
      {/* BANNER */}
      <div
        className="w-full h-[50vh] md:h-[500px] lg:h-[600px] bg-center bg-cover bg-no-repeat relative overflow-hidden "
        style={{
          backgroundImage: `url('https://res.cloudinary.com/dxcmuocjm/image/upload/v1762949004/2_-_PC_cvqxje.webp')`,
        }}
        role="img"
        aria-label="Glowify Banner"
      >
        {/* Decorative image as background; include hidden text for screen readers */}
        <span className="sr-only">Glowify Banner</span>
        <div className="absolute bottom-40 left-30 max-w-[390px]">
          <h1 className="text-black capitalize text-4xl font-bold font-serif mb-3">Beauty Inspired by Real Life</h1>
          <p className="text-gray-600 text-lg font-medium mb-4">Powered by nature and perfected by you, our clean skincare fits every real-life moment</p>
          <button className="text-black bg-white text-lg px-4 py-2">
            Shop Now
          </button>
        </div>
      </div>
      ...
      <div className="text-center py-6">
        <h2 className="text-2xl font-prata text-[#006A71]">
          {user
            ...
            : "Welcome to Cosmico, let your skin shine 🌟"}
        </h2>
      </div>

      {/* SHOP BY CATEGORY */}
      <section className="max-w-7xl mx-auto px-4 py-10 mt-20">
        <h2 className="text-3xl font-prata text-[#006A71] mb-4">
          Shop by Category
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {["Skincare", "Haircare", "Bodycare", "Wellness"].map(
            (categoryName, index) => (
              <Link
              ...
              >
                ...
                />
                <h3 className="text-md font-semibold text-[#006A71]">
                  {categoryName}
                </h3>
              </Link>
            )
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <h2 className="text-3xl font-prata text-[#006A71] mb-2">
          Latest Collection
        </h2>
        <p className="text-gray-600 mb-6">
          Explore our latest collection of personal care essentials crafted for
          ...
          {latestProducts.map((item) => (
            ...
            >
              <LazyLoad
                ...
                once
                placeholder={
                  <div className="bg-gray-200 h-40 w-full animate-pulse rounded mb-3" />
                }
              >
                <img
                  src={item.image}
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 mb-6">
          Explore our top-rated personal care products loved by our customers
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-sm text-gray-600">
              We offer free exchange on all products.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-gray-600">
              Return within 3 days hassle-free.
            </p>
          </div>
          <div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-100">
              High-quality personal care products designed with premium
              ingredients and thoughtful formulas for everyday use.
            </p>
          </div>
          <div>
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-300 mt-4">
              © 2024 Glowify. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
